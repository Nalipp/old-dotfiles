...
*mongodb
  ...
  import cvs file
    file must be saved as .cvs windows format type
...
// *mongo driver
    ...
    // delete a field from a single document
           db.domain.update({},{$unset: {keyName:1}},{multi: true});
...
// *pluralsight notes
  ...
  // inserting documents
    ...
    db.users.update({_id: 1}, {$inc: {points: -1}})            // decrement
  ...
  // retrieving documents
    ...
    db.courses.count()                                         // returns count of documents
